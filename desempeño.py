...
match nombre.lower():
    case "james" | "ricardo" | "maria" | "jose" | "luis" | "ramon" | "jesus" | "juan" | "alexandra" | "alejandra" | \
        ...
        print("Hola señor " + str(nombre))
    case _:
        print("perdon, no reconocí tu nombre")

#calcular edad
import datetime

# Introduce la fecha de nacimiento en formato 'YYYY-MM-DD'
print (f"vamos a calcular tu edad")
...
#IMC
print(f"vamos a calcular tu indice corporal")
...
def sumar(a, b):
    return a + b
print(f"que operacion quieres realizar?")
